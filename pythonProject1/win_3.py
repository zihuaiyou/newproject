...
# Form implementation generated from reading ui file 'win_3.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "地层模型压裂模拟程序"))
        ...
        self.action_1.setText(_translate("MainWindow", "修改射孔区裂缝形态"))
        self.action_2.setText(_translate("MainWindow", "修改地层性质"))
        self.action_4.setText(_translate("MainWindow", "修改地应力"))
        self.actionsuanli.setText(_translate("MainWindow", "算例创建向导"))
        self.action_3.setText(_translate("MainWindow", "修改地层分布"))
